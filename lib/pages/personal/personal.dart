...
class Personal extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Personal();
}
...
class _Personal extends State<Personal> {
  ...
  addMes() {
    ...
    stompClient?.send(
      ...
      body: json.encode({"lmsg": newMes,'uid':Global.uid}),
    );
  }
  ...
  void onConnect(StompFrame frame) {
    ...
    stompClient?.subscribe(
      destination: '/topic/user/'+Global.uid.toString()+'/getAllLMsg',
      callback: (frame) {
            ...
            leading: IconButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext context) => MyData(),
                ));
              },
